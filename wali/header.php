	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav navbar-left">
			...
			<li<?php if ($thisPage=="Data") echo " class=\"active\""; ?>><a href="data.php" data-toggle="tooltip" data-placement="bottom" title="Lihat Data Siswa"><span class="glyphicon glyphicon-list"></span> Lihat Data</a></li>
