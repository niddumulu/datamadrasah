	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav navbar-left">
			...
			<li<?php if ($thisPage=="Data") echo " class=\"active\""; ?>><a href="databaru.php" data-toggle="tooltip" data-placement="bottom" title="Lihat Data Siswa"><span class="glyphicon glyphicon-list"></span> Lihat Data</a></li>
			<li<?php if ($thisPage=="Tambah") echo " class=\"active\""; ?>><a href="tambah.php" data-toggle="tooltip" data-placement="bottom" title="Tambah Data siswa" ><span class="glyphicon glyphicon-user"></span> Tambah Data</a></li>
			<form name="cari" method="post" action="cari.php" role="search" class="navbar-form navbar-left">
				<div class="form-group">
					<input type="text" name="carinim" placeholder="Cari NIS Siswa" class="form-control">
				</div>
