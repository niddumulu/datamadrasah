<?php $thisPage="Edit"; ?>
<?php $title = "Edit Wali Kelas - Data Siswa" ?>
<?php $description = "Edit Wali Kelas - Data Siswa" ?>
<?php 
	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){ // jika tombol 'Simpan' dengan properti name="save" ditekan
				...
				$update = mysqli_query($koneksi, "UPDATE tbl_mahasiswa SET kelas='$kelas' WHERE nim='$nim'") or die(mysqli_error()); // query untuk mengupdate nilai entri dalam database
				if($update){ // jika query update berhasil dieksekusi
					header("Location: edit_wali_kelas.php?nim=".$nim."&pesan=sukses"); // tambahkan pesan=sukses pada url
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Nama Wali Kelas</label>
					<div class="col-sm-2">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="walikelas.php" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Batal">Batal</a>
					</div>
				</div>
			</form>
		</div> <!-- /.content -->
